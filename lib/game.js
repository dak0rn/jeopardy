			...
			<div class="border border-grey-darker p-4 shadow my-4 mx-auto" style="min-width: 900px; max-width: 90%">
				...
				<div class="flex w-full overflow-auto">
					<div
						...
						<div class="py-2 px-4 font-bold bg-gray-300 w-32 h-16 text-center">
							{{category}}
						</div>
						...
						<div
							...
							:class="[
								'px-4 py-4 text-center mt-2',
								{
									...
									'cursor-default': question.failed || question.answeredBy,
				...
				<question
					...
					@nobodyScored="nobodyScored"
					@playerFailed="$emit('playerFailed', $event)"
					v-if="null !== show" :state="state" :category="show[0]" :difficulty="show[1].difficulty" :index="show[2]" />
			</div>
