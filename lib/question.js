			...
			<div class="absolute right-0 top-0 left-0 bottom-0">
				<div class="bg-white max-w-xl mx-auto mt-8">
					...
					<div class="text-center font-bold">
					    <div class="float-right text-sm cursor-help mx-2" @click="showAnswer">?</div>
						{{category}} - {{difficulty}}
					</div>
					
					<div v-if="!image" class="whitespace-pre bg-gray-300 text-center text-2xl p-8">{{answer}}</div>
					...
					<div class="flex" v-if="null !== team">
						...
						<div class="flex-auto text-center py-4" v-if="changed">
							<action-button text="CANCEL" @click="$emit('bothLost', eventPayload)" />
						</div>
